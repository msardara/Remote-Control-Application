...
/*
 * MouseInput structure, that contains all info about the mouse event input to send to the system
 */
[StructLayout(LayoutKind.Sequential)]
internal struct MOUSEINPUT
{
    internal int dx;                /* The absolute position of the mouse, or the amount of motion since the last mouse event
    ...
    internal int dy;                /* The absolute position of the mouse, or the amount of motion since the last mouse event
                                     * was generated, depending on the value of the dwFlags member. Absolute data is specified
                                     * as the y coordinate of the mouse; relative data is specified as the number of pixels moved.
                                     */
    ...
    internal MOUSEEVENTF dwFlags;   /*  A set of bit flags that specify various aspects of mouse motion and button clicks.
                                     ...
                                     * MOUSEEVENTF_XUP flags simultaneously in the dwFlags parameter, because they both require
                                     * use of the mouseData field.
                                     */

    internal uint time;             /*The time stamp for the event, in milliseconds. If this parameter is 0, the system will
...
/*
 * Flags thai indicates the type of mouse event to send in the system
 */
[Flags]
internal enum MOUSEEVENTF : uint
{
    ABSOLUTE = 0x8000, /* The dx and dy members contain normalized absolute coordinates. If the flag is not set, dxand dy
                        * contain relative data (the change in position since the last reported position). This flag can be set,
                        * or not set, regardless of what kind of mouse or other pointing device, if any, is connected to the
                        * system. For further information about relative mouse motion, see the following Remarks section.
                        */

    HWHEEL = 0x01000,   /* The wheel was moved horizontally, if the mouse has a wheel.
                         * The amount of movement is specified in mouseData.
                         */

    MOVE = 0x0001,      /* Movement occurred. */
    MOVE_NOCOALESCE = 0x2000,  /* The WM_MOUSEMOVE messages will not be coalesced. The default behavior is to coalesce
                                * WM_MOUSEMOVE messages
                                */

    LEFTDOWN = 0x0002,  /* The left button was pressed. */
    LEFTUP = 0x0004,    /* The left button was releasd. */
    ...
    MIDDLEUP = 0x0040,  /* The right button was released. */
...
{
    internal VirtualKeyShort wVk;   /* A virtual-key code. The code must be a value in the range 1 to 254.
                                     * If the dwFlags member specifies KEYEVENTF_UNICODE, wVk must be 0.
                                     */

    internal ScanCodeShort wScan;   /* A hardware scan code for the key. If dwFlags specifies KEYEVENTF_UNICODE,
                                     * wScan specifies a Unicode character which is to be sent to the foreground application.
                                     */
    internal KEYEVENTF dwFlags;     /* Specifies various aspects of a keystroke. This member can
                                     * be certain combinations of the following values.
                                     */

    internal int time;              /* The time stamp for the event, in milliseconds.
                                     * If this parameter is zero, the system will provide its own time stamp.
                                     */

    internal UIntPtr dwExtraInfo;   /* An additional value associated with the keystroke.
                                     * Use the GetMessageExtraInfo function to obtain this information.
                                     */
}

/*
 * Flag that indicates the KeyEventType
 */
[Flags]
internal enum KEYEVENTF : uint
{
    ...
    SCANCODE = 0x0008,      /* f specified, wScan identifies the key and wVk is ignored. */

    UNICODE = 0x0004        /* If specified, the system synthesizes a VK_PACKET keystroke. The wVk parameter must be zero.
                             * his flag can only be combined with the KEYEVENTF_KEYUP flag. For more information, see the
                             * Remarks section.
                             */
}
...
{
    public UInt32 uMsg;     /* The message generated by the input hardware. */
    public UInt32 wParamL;  /* The low-order word of the lParam parameter for uMsg. */
    public UInt16 wParamH;  /* The high-order word of the lParam parameter for uMsg. */
};
...
public struct INPUT
{
    internal INPUTYPE type;     /* The type of the input event. This member can be one of the following values. */
...
/*
 * Flags with the input type
 */ 
[Flags]
internal enum INPUTYPE : uint
{
    INPUT_MOUSE = 0x0000,       /* The event is a mouse event. Use the mi structure of the union. */

    INPUT_KEYBOARD = 0x0001,    /* The event is a keyboard event. Use the ki structure of the union. */

    INPUT_HARDWARE = 0x0002,    /* The event is a hardware event. Use the hi structure of the union. */
}

/*
 * Union with the input structure.
 */
...
namespace SocketExample
{
    public static class InputSimulation
    {
        ...
        /*
         * Function that creates an INPUT structure to inject a mouse left button down event in the system queue.
         */
        public static INPUT mouseLeftDown()
        {
        ...
        /*
         * Function that creates an INPUT structure to inject a mouse left button up event in the system queue.
         */
        public static INPUT mouseLeftUp()
        {
            MOUSEINPUT mi = new MOUSEINPUT();
        ...
        /*
         * Function that creates an INPUT structure to inject a mouse right button up event in the system queue.
         */
        public static INPUT mouseRightUp()
        {
            MOUSEINPUT mi = new MOUSEINPUT();
        ...
        /*
         * Function that creates an INPUT structure to inject a mouse middle button down event in the system queue.
         */
        public static INPUT middleDown()
        {
            MOUSEINPUT mi = new MOUSEINPUT();
